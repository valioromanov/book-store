...
type Service interface {
	...
	PatchBook(context.Context, *BookPathcReq) (err error)
...
// MethodKey key.
var MethodNames = [4]string{"getBook", "postBook", "patchBook", "deleteBook"}

// BookPathcReq is the payload type of the book service patchBook method.
type BookPathcReq struct {
	ID          *int
	Title       *string
	Author      *string
	BookCover   []byte
